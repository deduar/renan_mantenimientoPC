                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url()?>mantenimiento/marcas/edit/<?php echo $presentacion->id;?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
                                                    <?php endif;?>
                                                    <?php if($permisos->delete == 1):?>
                                                    <a href="<?php echo base_url();?>mantenimiento/marcas/delete/<?php echo $presentacion->id;?>" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                                    <?php endif;?>
                                                </div>
                                            </td>
                                        </tr>
